...
module.exports = {
  ...
  // /////////askkk the way of selection//////
  // SELECT reg.user_id, reg.user_name, reg.user_email, prof.first_name, prof.last_name
  // FROM registration AS reg
  // LEFT JOIN profile AS prof ON reg.user_id = prof.user_id
  // WHERE reg.user_id = ?
